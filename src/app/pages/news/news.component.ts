...
@Component({
  ...
  styles: [
    ...
    .pagination-btn:hover:not(:disabled) {
      ...
      .header-decoration-left.anim-line-c,
      .header-decoration-right.anim-line-c {
...
export class NewsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    this.seoService.updateMetadata({
      title: 'Actualités',
      description:
        "Suivez les dernières actualités, événements et communications officielles du Conseil d'État de la République Démocratique du Congo.",
