...
@Component({
  ...
  styles: [`
    ...
    * {
    ...
    :host-context([data-theme="dark"]) .stats-section { background: linear-gradient(180deg, #243447 0%, #1a2332 100%); border-bottom-color: #2d4156; }
    :host-context([data-theme="dark"]) .stat-number { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .stat-label { color: #8899aa; }
    :host-context([data-theme="dark"]) .networks-section { background: #1a2332; }
    ...
    :host-context([data-theme="dark"]) .network-card { background: #243447; border-color: #2d4156; box-shadow: 0 2px 8px rgba(0,0,0,0.3); }
    :host-context([data-theme="dark"]) .network-card:hover { box-shadow: 0 8px 20px rgba(0,0,0,0.4); }
    :host-context([data-theme="dark"]) .network-card h3 { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .network-full-name { color: #8899aa; }
    :host-context([data-theme="dark"]) .network-description { color: #8899aa; }
    :host-context([data-theme="dark"]) .cooperation-section { background: linear-gradient(180deg, #243447 0%, #1a2332 100%); }
    :host-context([data-theme="dark"]) .domain-card { background: #243447; border-color: #2d4156; box-shadow: 0 2px 8px rgba(0,0,0,0.3); }
    :host-context([data-theme="dark"]) .domain-card:hover { box-shadow: 0 8px 20px rgba(0,0,0,0.4); border-color: #4fc3f7; }
    :host-context([data-theme="dark"]) .domain-card h3 { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .domain-card p { color: #8899aa; }
  `]
})
