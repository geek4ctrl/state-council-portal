...
@Component({
      ...
      @if (activeTab() === 'appointment') {
        <section class="hero-section">
          <div class="container">
            <div class="hero-grid">
              <div class="hero-left">
                <h1 class="appointment-hero-title" [innerHTML]="'steps.hero.appointment.title' | i18n"></h1>
              </div>
              <div class="vertical-line"></div>
              <div class="hero-right">
  ...
  styles: [`
    ...
    .hero-left h1.appointment-hero-title {
      margin: 0;
      font-size: clamp(1.8rem, 4vw, 2.9rem);
      font-weight: 700;
      letter-spacing: 2px;
    ...
    :host-context([data-theme="dark"]) .tab.active { color: #e4eaf0; border-bottom-color: #4fc3f7; }
    :host-context([data-theme="dark"]) .tab-separator { background: #2d4156; }
    :host-context([data-theme="dark"]) .form-section { background: #1a2332; }
    :host-context([data-theme="dark"]) .form-header h2 { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .form-subtitle { color: #8899aa !important; }
    ...
    :host-context([data-theme="dark"]) .form-group textarea:focus { border-color: #4fc3f7; }
    ...
    :host-context([data-theme="dark"]) .select-trigger { background: #243447; border-color: #2d4156; }
    :host-context([data-theme="dark"]) .select-trigger:hover { border-color: #4fc3f7; }
    :host-context([data-theme="dark"]) .select-trigger span { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .select-trigger span.placeholder { color: #a0b0c0; }
    :host-context([data-theme="dark"]) .dropdown-arrow { stroke: #8899aa; }
    :host-context([data-theme="dark"]) .select-dropdown { background: #2a3d52; box-shadow: 0 8px 24px rgba(0,0,0,0.5); }
    :host-context([data-theme="dark"]) .dropdown-item { color: #e4eaf0; border-bottom-color: #2d4156; }
    :host-context([data-theme="dark"]) .dropdown-item:hover { background-color: #2d4156; }
    :host-context([data-theme="dark"]) .dropdown-item:active { background-color: #2d4156; }
    :host-context([data-theme="dark"]) .form-submit button { background: #243447; color: #4fc3f7; border-color: #4fc3f7; }
    :host-context([data-theme="dark"]) .form-submit button:hover { background: transparent; color: #81d4fa; }
    :host-context([data-theme="dark"]) .appeal-step { background: #243447; border-left-color: #4fc3f7; }
    :host-context([data-theme="dark"]) .appeal-step:hover { background: #2a3d52; }
    :host-context([data-theme="dark"]) .step-body h3 { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .step-body p { color: #8899aa; }
    :host-context([data-theme="dark"]) .have-questions { background: rgba(79,195,247,0.08); }
    :host-context([data-theme="dark"]) .have-questions h3 { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .have-questions p { color: #8899aa; }
    :host-context([data-theme="dark"]) .email-cta { background: #243447; color: #4fc3f7; border-color: #4fc3f7; }
    :host-context([data-theme="dark"]) .email-cta:hover { background: #4fc3f7; color: #1a2332; }
    :host-context([data-theme="dark"]) .faq-item { background: #243447; border-color: #2d4156; }
    :host-context([data-theme="dark"]) .faq-item:hover { border-color: #4fc3f7; }
    :host-context([data-theme="dark"]) .faq-item.open { border-color: #4fc3f7; }
    :host-context([data-theme="dark"]) .faq-question { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .faq-question:hover { background: #2a3d52; }
    :host-context([data-theme="dark"]) .faq-item.open .faq-question { background: rgba(79,195,247,0.08); }
    :host-context([data-theme="dark"]) .faq-answer p { color: #8899aa; border-top-color: #2d4156; }
    :host-context([data-theme="dark"]) .map-section { background: linear-gradient(180deg, #1a2332 0%, #243447 50%, #1a2332 100%); }
    :host-context([data-theme="dark"]) .map-header h2 { color: #e4eaf0; }
    :host-context([data-theme="dark"]) .map-subtitle { color: #8899aa; }
    :host-context([data-theme="dark"]) .address-card { background: #243447; border-color: #2d4156; box-shadow: 0 8px 24px rgba(0,0,0,0.4); }
    :host-context([data-theme="dark"]) .address-text p { color: #8899aa; }
    :host-context([data-theme="dark"]) .address-line1 { color: #e4eaf0 !important; }
    :host-context([data-theme="dark"]) .map-container { box-shadow: 0 24px 60px rgba(0,0,0,0.4); border-color: #2d4156; }
  `]
})
