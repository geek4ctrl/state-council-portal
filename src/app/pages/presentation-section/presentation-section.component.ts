          ...
          <div class="container">
            @if (isMission()) {
              ...
              <div class="section-card procedures-content">
                <h2 class="procedures-main-title">{{ 'proceduresPage.title' | i18n }}</h2>
                <p>{{ 'proceduresPage.intro' | i18n }}</p>

                <h3 class="procedures-section-title">{{ 'proceduresPage.s1.title' | i18n }}</h3>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s1.filing.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s1.filing.p1' | i18n }}</p>
                <p>{{ 'proceduresPage.s1.filing.p2' | i18n }}</p>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s1.rapporteur.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s1.rapporteur.p1' | i18n }}</p>
                <p>{{ 'proceduresPage.s1.rapporteur.p2' | i18n }}</p>
                <p>{{ 'proceduresPage.s1.rapporteur.p3' | i18n }}</p>
                <p>{{ 'proceduresPage.s1.rapporteur.p4' | i18n }}</p>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s1.examination.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s1.examination.p1' | i18n }}</p>
                <p>{{ 'proceduresPage.s1.examination.p2' | i18n }}</p>
                <ol class="procedures-list">
                  <li>{{ 'proceduresPage.s1.examination.list1' | i18n }}</li>
                  <li>{{ 'proceduresPage.s1.examination.list2' | i18n }}</li>
                  <li>{{ 'proceduresPage.s1.examination.list3' | i18n }}</li>
                  <li>{{ 'proceduresPage.s1.examination.list4' | i18n }}</li>
                </ol>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s1.opinion.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s1.opinion.p1' | i18n }}</p>
                <p>{{ 'proceduresPage.s1.opinion.p2' | i18n }}</p>

                <h3 class="procedures-section-title">{{ 'proceduresPage.s2.title' | i18n }}</h3>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s2.filing.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s2.filing.p1' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.filing.p2' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.filing.p3' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.filing.p4' | i18n }}</p>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s2.preliminary.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s2.preliminary.p1' | i18n }}</p>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s2.instruction.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s2.instruction.p1' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.instruction.p2' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.instruction.p3' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.instruction.p4' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.instruction.p5' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.instruction.p6' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.instruction.p7' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.instruction.p8' | i18n }}</p>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s2.hearing.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s2.hearing.p1' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.hearing.p2' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.hearing.p3' | i18n }}</p>
                <ol class="procedures-list">
                  <li>{{ 'proceduresPage.s2.hearing.list1' | i18n }}</li>
                  <li>{{ 'proceduresPage.s2.hearing.list2' | i18n }}</li>
                  <li>{{ 'proceduresPage.s2.hearing.list3' | i18n }}</li>
                  <li>{{ 'proceduresPage.s2.hearing.list4' | i18n }}</li>
                </ol>
                <p>{{ 'proceduresPage.s2.hearing.p4' | i18n }}</p>

                <h4 class="procedures-sub-title">{{ 'proceduresPage.s2.judgment.title' | i18n }}</h4>
                <p>{{ 'proceduresPage.s2.judgment.p1' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.judgment.p2' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.judgment.p3' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.judgment.p4' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.judgment.p5' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.judgment.p6' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.judgment.p7' | i18n }}</p>
                <p>{{ 'proceduresPage.s2.judgment.p8' | i18n }}</p>

                <div class="procedures-footnotes">
                  <p><sup>1</sup> {{ 'proceduresPage.footnotes.f1' | i18n }}</p>
                  <p><sup>2</sup> {{ 'proceduresPage.footnotes.f2' | i18n }}</p>
                  <p><sup>3</sup> {{ 'proceduresPage.footnotes.f3' | i18n }}</p>
                  <p><sup>4</sup> {{ 'proceduresPage.footnotes.f4' | i18n }}</p>
                  <p><sup>5</sup> {{ 'proceduresPage.footnotes.f5' | i18n }}</p>
                </div>
              </div>
