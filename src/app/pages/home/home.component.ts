    ...
    `
      * {
      ...
      .sphere-core {
        ...
        color: #1f9bd9;
        box-shadow:
          0 0 30px rgba(31, 155, 217, 0.3),
          inset 0 0 20px rgba(31, 155, 217, 0.1);
      ...
      .loader-fill {
        height: 100%;
        background: linear-gradient(90deg, #1f9bd9, #e0b98a, #1f9bd9);
        background-size: 200%;
      ...
      .arr-top {
        ...
        right: 0;
        height: 6px;
        background: rgba(31, 155, 217, 0.5);
      ...
      .h-arr:hover {
        ...
        background: rgba(31, 155, 217, 0.25);
        border-color: #1f9bd9;
      ...
      .kf-bg-aura {
        ...
        height: 500px;
        border-radius: 50%;
        background: radial-gradient(circle, rgba(31, 155, 217, 0.12), transparent 70%);
        pointer-events: none;
      ...
      .card-edge-r {
        ...
        width: 3px;
        height: 100%;
        background: linear-gradient(to bottom, transparent, rgba(31, 155, 217, 0.5), transparent);
        opacity: 0;
        transition: opacity 0.3s ease;
      }
      .card-edge-b {
        ...
        height: 3px;
        width: 100%;
        background: linear-gradient(to right, transparent, rgba(31, 155, 217, 0.5), transparent);
        opacity: 0;
        transition: opacity 0.3s ease;
      }
      ...
      .sec-line-c {
        width: 160px;
        height: 1px;
        background: linear-gradient(90deg, transparent, rgba(31, 155, 217, 0.7), transparent);
      }
      .anim-line-c {
      ...
      .ql-divider {
        width: 1px;
        background: linear-gradient(to bottom, transparent, rgba(31, 155, 217, 0.4), transparent);
        flex-shrink: 0;
      }
      .ql-card {
        flex: 1;
      ...
      .flip-back {
        transform: rotateY(180deg);
        background: linear-gradient(135deg, #82bcdc, #2c3e50);
      }
      .flip-back-inner {
        display: flex;
        flex-direction: column;
      ...
      .o-icon-orbit {
        ...
        inset: -6px;
        border-radius: 50%;
        border: 1px dashed rgba(31, 155, 217, 0.4);
        opacity: 0;
        transition: opacity 0.3s ease;
      }
      .orbit-dot {
      ...
      .o-card-beam {
        ...
        width: 2px;
        height: 0;
        background: linear-gradient(to top, #1f9bd9, transparent);
        opacity: 0;
        transition:
          height 0.5s ease,
          opacity 0.5s ease;
      ...
      .exp-grid-bg {
        ...
        inset: 0;
        background-image:
          linear-gradient(rgba(31, 155, 217, 0.07) 1px, transparent 1px),
          linear-gradient(90deg, rgba(31, 155, 217, 0.07) 1px, transparent 1px);
      ...
      .exp-icon {
        ...
        height: 52px;
        border-radius: 12px;
        background: linear-gradient(135deg, rgba(31, 155, 217, 0.2), rgba(31, 155, 217, 0.04));
        color: var(--accent);
        display: flex;
        align-items: center;
        justify-content: center;
      ...
      .ct-item:hover {
        background: rgba(31, 155, 217, 0.05);
      }
      .ct-icon-box {
        width: 52px;
        height: 52px;
        flex-shrink: 0;
        border-radius: 14px;
        background: linear-gradient(135deg, rgba(31, 155, 217, 0.18), rgba(31, 155, 217, 0.05));
        display: flex;
        align-items: center;
        justify-content: center;
        color: #1f9bd9;
      ...
      .ct-item:hover .ct-icon-box {
        ...
        box-shadow: 0 12px 28px rgba(31, 155, 217, 0.25);
      }
      .ct-icon-ring {
        position: absolute;
        inset: -5px;
        border-radius: inherit;
        border: 2px solid rgba(31, 155, 217, 0.3);
        opacity: 0;
        transition: opacity 0.3s ease;
      }
      ...
      .ct-sep {
        width: 1px;
        background: linear-gradient(to bottom, transparent, rgba(31, 155, 217, 0.6), transparent);
      }
      ...
      .pres-a1 {
        ...
        top: -200px;
        right: -150px;
        background: radial-gradient(circle, rgba(31, 155, 217, 0.22), transparent 70%);
      ...
      .pres-a3 {
        ...
        top: 40%;
        left: 40%;
        background: radial-gradient(circle, rgba(31, 155, 217, 0.08), transparent 70%);
      ...
      .pres-badge {
        ...
        bottom: 20px;
        left: 20px;
        background: rgba(31, 155, 217, 0.9);
      ...
      .pres-btn-aura {
        ...
        inset: -2px;
        border-radius: inherit;
        background: radial-gradient(circle, rgba(31, 155, 217, 0.4), transparent 70%);
        opacity: 0;
        pointer-events: none;
        transition: opacity 0.3s ease;
      }
      ...
      .nl-scanlines {
        ...
        background: repeating-linear-gradient(
          0deg,
          rgba(31, 155, 217, 0.03) 0,
          rgba(31, 155, 217, 0.03) 1px,
          transparent 1px,
          transparent 40px
        );
      ...
      .nl-line {
        ...
        max-width: 180px;
        height: 1px;
        background: linear-gradient(90deg, transparent, rgba(31, 155, 217, 0.8), transparent);
      }
      .nl-grid {
        overflow: hidden;
        margin: 55px 0 44px;
      ...
      .nl-card:hover .nl-img-badge {
        ...
        box-shadow: 0 6px 18px rgba(31, 155, 217, 0.5);
      }
      .nl-img-scan {
        position: absolute;
        left: 0;
        right: 0;
        height: 2px;
        background: linear-gradient(90deg, transparent, rgba(31, 155, 217, 0.6), transparent);
        top: 0;
        opacity: 0;
        pointer-events: none;
      }
      ...
      .nl-card-glow {
        ...
        inset: 0;
        border-radius: inherit;
        background: radial-gradient(circle at 50% 100%, rgba(31, 155, 217, 0.1), transparent 70%);
        opacity: 0;
        transition: opacity 0.4s ease;
        pointer-events: none;
      }
...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  presSlides: PresidentSlide[] = [
    {
      ...
      image: 'https://res.cloudinary.com/dhqvb8wbn/image/upload/v1772020345/Brigitte_NSENSELE_wa_NSENSELE.jpg_2_vgiv72.jpg',
      paragraphKeys: [
  ...
  private initHeroCanvas() {
    ...
    const draw = () => {
      ...
      particles.forEach((p) => {
        ...
        ctx.fillStyle = `rgba(31,155,217,${p.alpha})`;
        ctx.fill();
      });
  ...
  tilt(e: MouseEvent) {
    ...
    el.style.boxShadow = `${-ty * 1.5}px ${tx * 1.5}px 50px rgba(0,0,0,.18), 0 25px 60px rgba(31,155,217,.12)`;
  ...
  private renderCharts() {
    ...
    this.charts = [
      Highcharts.chart(this.chartA.nativeElement, {
        ...
        tooltip: { backgroundColor: '#82BCDC', style: { color: '#fff' }, borderColor: '#82BCDC' },
        series: [
          {
            type: 'column',
            name: 'Cases',
