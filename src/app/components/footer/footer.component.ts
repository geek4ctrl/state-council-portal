...
@Component({
  ...
  styles: [
    ...
    .footer-main::before { content: ''; position: absolute; inset: 0; background: radial-gradient(circle at 50% 0%, rgba(191, 152, 116, 0.22), transparent 55%), linear-gradient(90deg, rgba(255, 255, 255, 0.3), transparent 45%, rgba(255, 255, 255, 0.2)); pointer-events: none; }
    ...
    .footer-column h3::after { content: ''; position: absolute; left: 0; bottom: 0; width: 36px; height: 2px; background: linear-gradient(90deg, #BF9874, transparent); }
    ...
    .footer-column ul li a:hover { color: #BF9874; text-decoration: underline; text-underline-offset: 4px; }
    ...
    .social-icon { width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; background-color: #ffffff; border-radius: 50%; color: #1f2937; border: 1px solid rgba(191, 152, 116, 0.35); box-shadow: 0 6px 14px rgba(10, 16, 32, 0.12); text-decoration: none; transition: all 0.3s ease; }
    .social-icon:hover { background-color: #BF9874; border-color: #BF9874; color: #ffffff; }
    ...
    .privacy-link:hover { color: #BF9874; }
